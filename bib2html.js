  ...
  this.bibtex = function() {
    while (this.tryMatch("@")) {
      ...
      if (d == "@STRING") {
        ...
        this.entry();
        this.entries[this.currentEntry]["BIBTEXCODE"] = this.input.substring(
          this.posBegin,
          this.pos + 1
        );
      }
  ...
  this.displayBibtex = function(input, output) {
    ...
    for (var entryKey in entries)
      if (!entries[entryKey]["BIBTEXCODE"].startsWith("@proceedings{")) {
        ...
        // find template
        var tpl = $(".bibtex_template")
          .clone()
          .removeClass("bibtex_template");
        ...
        for (var index in keys) {
          ...
          var value = entry[key] || "";
          tpl
            .find("span:not(a)." + key.toLowerCase())
            .html(this.fixValue(value));
...
function jQueryCode() {
  $(document).ready(function() {
    ...
    if ($(".bibtex_template").length == 0) {
      $("body").append(
        '<span class="tag"></span><div class="bibtex_template"><div class="if author" style="font-weight: bold;">\n  <span class="if year">\n    <span class="year"></span>, \n  </span>\n  <span class="author"></span>\n  <span class="if url" style="margin-left: 20px">\n    <a class="url" style="color:black; font-size:10px">(view online)</a>\n  </span>\n</div>\n<div style="margin-left: 10px; margin-bottom:5px;">\n  <span class="title"></span>\n</div></div>'
      );
    }
    bibtex_js_draw();
  });
